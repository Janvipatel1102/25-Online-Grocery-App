...
public class categoryWiseViewModel extends AndroidViewModel {
    ...
    public LiveData<List<CategoryWiseItems>> doMySearch(String Query, List<Pair<Float,Float>> price_filters_list, List<Float> discount_filters_list, List<Float> rating_filters_list, List<Boolean> isStockFilters_list, String column, String sortColumnName, String order, int limit, int offset)
    {
      ...
      //  Log.d(String.valueOf(categoryWiseViewModel.this),filter);
       ...
       Log.d(String.valueOf(categoryWiseViewModel.this),queryString);
        ...
        query = new SimpleSQLiteQuery(queryString);
        return mRepository.doMySeach(query);
    }
