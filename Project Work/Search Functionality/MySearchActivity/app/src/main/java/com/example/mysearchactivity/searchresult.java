...
public class searchresult<async> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //  getAllCategories();
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            doMySearch(query,price_filters_list,discount_filters_list,rating_filters_list,isStock_filters_list,column,sortColumnName,order,limit,offset);
    ...
    public  void doMySearch(String Query,List<Pair<Float,Float>> price_filters,List<Float> discount_filters,List<Float> rating_filters,List<Boolean> isStockFilters,String column,String sortColumnName,String order,int limit,int offset)
    {
        categoryWiseViewModel.doMySearch("%"+Query+"%",price_filters,discount_filters,rating_filters,isStockFilters,column,sortColumnName,order,limit,offset).observe(this, new Observer<List<CategoryWiseItems>>() {
            @Override
